                    ...
                    <form method="post" name="contact-us" action="">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <a class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit" href="index.php
                                ">Send Message</a>
    ...
    <div class="inner container">
         <div class="row">
         	...
         	<div class="col-md-12 d-flex align-items-center">
                <p class="mx-auto text-center mb-0">Copyright 2022. Todos los Derechos Reservados. Diseñado por <a href="#" target="_blank">Ezequiel Aguilar</a></p>
         	</div>
